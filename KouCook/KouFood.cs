...
{
    [PluginFunction(Name = "随机获取一个美食")]
    public override object? Default([PluginArgument(Name = "指定美食")]string? str = null)
    {
    ...
    public string DeleteFood([PluginArgument(Name = "美食ID")] List<int> id)
    {
    ...
    [PluginFunction(Name = "加美食", ActivateKeyword = "add", EnableAutoNext = true)]
    public string AddFood(
        [PluginArgument(Name = "美食名字")] string foodName,
        [PluginArgument(Name = "美食图片")] KouImage foodImage)
    {
