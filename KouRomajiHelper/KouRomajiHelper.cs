...
namespace KouFunctionPlugin.Romaji
{
    ...
    public class KouRomajiHelper : KouPlugin<KouRomajiHelper>
    {
        ...
        [PluginFunction(ActivateKeyword = "念|读|谐音", Name = "Kou念罗马音", Help = "给Kou罗马音让她念吧，不会的罗马音可以教教")]
        ...
        [PluginFunction(ActivateKeyword = "add|教|教教", Name = "教教Kou谐音", Help = "添加谐音到数据库 用法：<罗马音，谐音>")]
